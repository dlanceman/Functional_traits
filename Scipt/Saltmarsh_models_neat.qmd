...
```{r Data, echo = FALSE}
salt <- read_excel(here("Data/Functional_traits_combined_data.xlsx"), sheet = "Saltmarsh") %>% 
  arrange(Date, Time) %>% 
...
salt_comm_comp <- read_excel(here("Data/salt_comm_comp.xlsx"), sheet = "alldata")
...
ggsave(here("Output/Saltmarsh_elev_doc.jpg"), width = 2400, height = 1500, units = "px")
...
ggsave(here("Output/Saltmarsh_comm_comp.jpg"), width = 2400, height = 1500, units = "px")
```
...
ggsave(here("Output/Saltmarsh_cover_poster.jpg"), width = 2400, height = 2400, units = "px")
```
...
ggsave(here("Output/Saltmarsh_burrows_grey.jpg"), width = 2400, height = 1500, units = "px")
...
ggsave(here("Output/Saltmarsh_burrows_poster.jpg"), width = 2400, height = 2400, units = "px")
```
