...
# 6a. Mangrove tree height


# C. Hunter and Maroochy together (for YSR)
...
# plot natural sites
ggplot(mantree_comm_nat, aes(x = Site, y = total_saplings)) +
  geom_boxplot() +
  geom_jitter(width=0.1) +
    labs(y = "Number of saplings per 100m2", x = "Site") +
  theme_classic() 
