...
M18.1 <- glmmTMB(Trees ~ Estuary + rest_status + Estuary:rest_status + (1|Site) + offset(log(Quadrat_size_m2)), family = "nbinom2", data = mantree_comm)
...
# without elevation
M19.1 <- glmmTMB(Saplings ~ Estuary + rest_status + Estuary:rest_status + (1|Site) + offset(log(Quadrat_size_m2)), family = "nbinom2", data = mantree_comm)
...
M19.31 <- glmmTMB(`Seedlings_<30cm_1x1` ~ Estuary + rest_status + Estuary:rest_status + (1|Site), family = "nbinom2", data = manq_comm)
...
# without elevation
M20.3 <- glmmTMB(Hollows ~ Estuary + rest_status + Estuary:rest_status + offset(log(Quadrat_size_m2)) + (1|Site), family = "nbinom2", data = mantree_comm)
...
# without elevation
M21.1 <- glmmTMB(Cover_prop ~ Estuary + rest_status + Estuary:rest_status + (1|Site), family = "beta_family", data = mantree_comm)
...
M24.5 <- glmmTMB(Pneu_0.5x0.5 ~ Estuary + rest_status + Estuary:rest_status + (1|Site/Combo), family = "gaussian", data = manq_comm)
...
# without elevation
M25.3 <- glmmTMB(sqrt(Pneu_ht_mm) ~ Estuary + rest_status + Estuary:rest_status + (1|Site/Combo/Subquadrat), family = "gaussian", data = manq)
...
M30.3 <- glmmTMB(log(Area) ~ Estuary + Species + Tree_sapling + rest_status + Species:rest_status + Estuary:rest_status + (1|Site/Combo/Tree), family = "gaussian", data = manleafandherb_nored)
